...
class App extends React.Component {
   ...
   */
  componentDidMount() {
    // COMMENTED OUT UNTIL ASSIGNMENTS ARE DONE AND I GET AROUND TO ENABLING HTTPS ON api.alexlipianu.com
    // fetch('http://api.alexlipianu.com')
      ...
      },
      {
        ...
        data: {
          ...
          projects: [
            {
              title: 'Imgrypt',
              image: 'images/thumbnails/imgrypt.png',
            ...
            {
              title: 'Website',
              image: 'images/thumbnails/site.png',
              ...
              links: {
                github: 'https://github.com/alipianu'
              }
            },
            {
              title: 'Paint Street Fighter',
              image: 'images/thumbnails/psf.jpg',
    ...
    // TODO: REMOVE ONCE HTTPS ENABLED ON api.alexlipianu.com
    const data = {};
    const sections = ['splash', 'about', 'timeline', 'skills', 'experience', 'projects', 'pens'];
    sections.forEach((section) => {
      const sectionJson = json.find((x) => x._id === section);
